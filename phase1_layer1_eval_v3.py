...
print(f'=== "{VERSION_LABEL}" REVISION 5 -- Phase 1 Layer 1 Signal Log (v3, OR-gate + hard floor) ===')
print(f"Raw signals: {len(signals)}")
print(f"Evaluated: {len(results)}  (skipped: {len(skipped)})")
print(f"Layer 1 PASS: {n_pass} / {len(results)}")

with open('/home/claude/smc_bot/diag/backtest/phase1_layer1_signal_log_v3.json', 'w') as f:
